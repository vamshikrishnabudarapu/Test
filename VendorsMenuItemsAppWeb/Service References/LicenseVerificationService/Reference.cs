...
namespace VendorsMenuItemsAppWeb.LicenseVerificationService {
    ...
    public interface IVerificationService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(VendorsMenuItemsAppWeb.LicenseVerificationService.ServiceUnavailableFault), Action="http://tempuri.org/IVerificationService/VerifyEntitlementTokenServiceUnavailableF" +
            ...
            "rm.Common.Fault")]
        [System.ServiceModel.FaultContractAttribute(typeof(VendorsMenuItemsAppWeb.LicenseVerificationService.ServiceInternalErrorFault), Action="http://tempuri.org/IVerificationService/VerifyEntitlementTokenServiceInternalErro" +
            ...
            "rm.Common.Fault")]
        VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse VerifyEntitlementToken(VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVerificationService/VerifyEntitlementToken", ReplyAction="http://tempuri.org/IVerificationService/VerifyEntitlementTokenResponse")]
        System.Threading.Tasks.Task<VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse> VerifyEntitlementTokenAsync(VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenRequest request);
        ...
        VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse VerifyEntitlementTokenRest(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVerificationService/VerifyEntitlementTokenRest", ReplyAction="http://tempuri.org/IVerificationService/VerifyEntitlementTokenRestResponse")]
        System.Threading.Tasks.Task<VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse> VerifyEntitlementTokenRestAsync(string token);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IVerificationServiceChannel : VendorsMenuItemsAppWeb.LicenseVerificationService.IVerificationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class VerificationServiceClient : System.ServiceModel.ClientBase<VendorsMenuItemsAppWeb.LicenseVerificationService.IVerificationService>, VendorsMenuItemsAppWeb.LicenseVerificationService.IVerificationService {
        ...
        public VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse VerifyEntitlementToken(VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenRequest request) {
            return base.Channel.VerifyEntitlementToken(request);
        }
        
        public System.Threading.Tasks.Task<VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse> VerifyEntitlementTokenAsync(VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenRequest request) {
            return base.Channel.VerifyEntitlementTokenAsync(request);
        }
        
        public VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse VerifyEntitlementTokenRest(string token) {
            return base.Channel.VerifyEntitlementTokenRest(token);
        }
        
        public System.Threading.Tasks.Task<VendorsMenuItemsAppWeb.LicenseVerificationService.VerifyEntitlementTokenResponse> VerifyEntitlementTokenRestAsync(string token) {
